...
const Home = () => {
  ...
  return (
    <>
      ...
      {/* Content */}
      <div className="relative z-10 flex flex-col items-start justify-end h-full pb-16 pl-12 text-white">
      <h1 className="text-7xl font-extrabold mb-6 leading-tight">Driven by Passion.</h1>
      <button
        className="px-6 py-3 border border-white text-white text-lg font-medium uppercase hover:bg-white hover:text-black transition-all duration-300"
      >
        Discover Our Models
      </button>
      </div>
